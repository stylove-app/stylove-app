...
export function TravelPackIllustration({ width = 280, height = 280 }: IllustrationProps) {
  return (
    <View style={[styles.frame, { width, height }]}>
      <View style={styles.ambientOrb} />
      <View style={styles.suitcase}>
        <View style={styles.suitcaseLid} />
        <View style={styles.suitcaseLatch} />
        <View style={styles.suitcaseHandle} />
        <View style={styles.suitcaseInterior}>
          <View style={styles.packedRow}>
            <View style={[styles.packedItem, styles.packedShirt]} />
            <View style={[styles.packedItem, styles.packedFold]} />
          </View>
          <View style={styles.packedRow}>
            <View style={[styles.packedItem, styles.packedShoe]} />
            <View style={[styles.packedItem, styles.packedPouch]} />
          </View>
          <View style={styles.packedDivider} />
        </View>
        <View style={styles.suitcaseWheelLeft} />
        <View style={styles.suitcaseWheelRight} />
      </View>
    </View>
  );
}
